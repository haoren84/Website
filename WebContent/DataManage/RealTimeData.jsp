...
<body>
	...
	$(function() {
		...
		if (window.parent != null && window.parent != undefined) {
			...
			if(window.parent.curNode&&window.parent.curNode.attributes){
				...
				LoadTableData(window.parent.curNode.attributes.structID,window.parent.curNode.attributes.monitorID);
	...
	function GetRealTimeData(structID,monitorID){
	...
	function LoadTableData(structID,monitorID){
		
		var objRealTime=GetRealTimeData(window.parent.curNode.attributes.structID,window.parent.curNode.attributes.monitorID);
		...
		if(objRealTime){
			...
			if(nObjLength>0){
				...
				var strCaption = "<caption><p>监测项目：" + objRealTime[0].monitorName + "的历史数据</p></caption>";//标题
